...
<p align="center">
  <img src="https://img.shields.io/badge/Experience-10%2B%20Years-0F172A?style=for-the-badge" alt="10+ years experience" />
  <img src="https://img.shields.io/badge/Role-Principal%20Engineer-2563EB?style=for-the-badge" alt="Principal Engineer" />
  <img src="https://img.shields.io/badge/Domain-Fintech%20%7C%20Logistics%20%7C%20SaaS-059669?style=for-the-badge" alt="Domains" />
</p>
...
```mermaid
flowchart LR
    Channels[SMS / RCS / MMS] --> Gateway[API Gateway]
    Gateway --> Services[Node.js Microservices]
    Services --> Queue[SQS + SNS]
    Queue --> Workers[AWS Lambda Workers]
    Workers --> Streams[Kinesis Event Streams]
    Workers --> Workflow[Step Functions]
    Workflow --> Data[(MongoDB + DynamoDB)]
    Services --> Security[KMS + Secrets Manager]
    Workers --> Monitoring[CloudWatch Dashboards]
```
